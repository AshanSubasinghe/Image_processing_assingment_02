...
img = cv2.imread(r'C:\Image_Processing_2\Crop_field_cropped.jpg', cv2.IMREAD_COLOR)
if img is None:
...
print("Estimated crop field angle (in degrees) using the proposed algorithm:", ransac_angle_degrees)
